    ...
    <div id="Servicos" className="bg-black w-full min-h-screen inset-0">
        ...
        <div className="grid md:grid-cols-3 max-w-screen-lg mx-auto gap-10 mt-16 px-5">
            ...
            <div className="flex gap-4 items-start flex-col ">
                ...
                <div>
                    <h3 className="text-white font-semibold text-xl"> Expressive API</h3>
                    <p className="mt-1 text-gray-500"> You don't need to be an expert to use our plugin. Our expressive API is
            ...
            <div className="flex gap-4 items-start flex-col ">
                ...
                <div>
                    <h3 className="text-white font-semibold text-xl">Highly performant</h3>
                    <p className="mt-1 text-gray-500"> You can make sure your website or app is highly performant with a built-in
            ...
            <div className="flex gap-4 items-start flex-col ">
                ...
                <div>
                    <h3 className="text-white font-semibold text-xl">No dependencies </h3>
                    <p className="mt-1 text-gray-500"> Our plugins do not have any external dependencies so our plugin has the
