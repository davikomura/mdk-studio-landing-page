           ...
           <nav className="bg-gray-800 fixed top-0 left-0 right-0 shadow-md py-4 px-4 sm:px-10 bg-transparent max-lg:bg-[#202626]  max-lg: backdrop-blur-sm bg-black/10">
                ...
                <div className={`sm:hidden ${menuOpen ? 'block' : 'hidden'}`}  id="mobile-menu">
                    <div className="space-y-1 px-2 pb-3 pt-2">
                        ...
                        <a href="#servicos" className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white" aria-current="page">Serviços</a>
