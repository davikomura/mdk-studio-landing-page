...
const Formulario = () => {
    return(
        ...
        <div class="container px-6 py-12 mx-auto">
            <div>
                <p class="font-medium text-blue-500 dark:text-blue-400">Fale conosco</p>
    
                <h1 class="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white">Converse com nossa equipe</h1>
    
                <p class="mt-3 text-gray-500 dark:text-gray-400">Adoraríamos ouvir de você. Por favor preencha este formulário ou envie-nos um e-mail.</p>
            </div>
    
            <div class="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2">
                <div class="grid grid-cols-1 gap-12 md:grid-cols-1">
                    <div>
                        <span class="inline-block p-4 text-blue-500 rounded-full bg-blue-100/80 dark:bg-gray-800">
                        ...
                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Nosso time esta aqui para ajudar</p>
                        <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">mdkstudioslz@gmail.com</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Segunda a Sexta das 8h às 17h.</p>
                        <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">+55 (98) 90000-0000</p>
                    </div>
                </div>
                ...
                <div class="p-4 py-6 rounded-lg bg-gray-50 dark:bg-gray-800 md:p-8">
                    <form>
                        ...
                        <div class="w-full mt-4">
                            ...
                            <textarea class="block w-full h-32 px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg md:h-56 dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Escreva aqui"></textarea>
                        </div>
